...
<div class="container">
      ...
      <table class="table table-striped table-bordered table-sm">
        ...
        <tr v-for="item in items" :key="item.idnumber">
          ...
          <td><button class="btn btn-info" @click="item.edit = !item.edit">Edit<i class="far fa-edit"></i></button>
            <button class="btn btn-danger" @click="removeItem(index)">Delete<i class="far fa-trash-alt"></i></button></td>
        </tr>
      </table>
</div>
